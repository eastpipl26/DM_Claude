...
**2026-07-16 추가 (RFI 방식 회신기한 규칙):** ⏳대기로 바꿀 때는 마감일 필드에 **회신기한을 반드시 기입**한다 — 도요님이 기한을 말 안 하면 기본값 +7일. 기한이 지나면 F/U(재촉) 로그를 남기고 기한을 재설정한다. F/U 이력은 지연 책임 방어 문서가 되므로 매번 기록. 근거: 건설 RFI 로그 표준 관행(회신기한 7~14일 + 도과 시 반복 F/U). [[feedback-weekly-review-and-decision-tag]]와 연계.
